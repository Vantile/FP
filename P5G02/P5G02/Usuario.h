...
bool validarContrasenia(const tUsuario &usuario, std::string contrasenia); // Devuelve true si la contraseña es correcta.
void destruir(tUsuario &usuario); // Destruye de la memoria dinámica un dato tipo tUsuario.
