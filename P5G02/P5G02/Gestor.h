...
void apagar(tGestor &gestor); // Apaga el gestor (guarda todas las listas).
void destruir(tGestor &gestor); // Destruye de la memoria dinámica un dato tipo tGestor.
...
void mostrarCorreosBandeja(tGestor &gestor, bool entrada); // Muestra los correos de la bandeja.
